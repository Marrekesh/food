...
function calc() {
  var element = document.querySelector('.calculating__result span'); // let sex = 'famale', 
  //     height, weight, age, 
  //     ratio = 1.375;
...
function card() {
  var AddCard = /*#__PURE__*/function () {
    function AddCard(src, alt, title, descr, price, parentSelector) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_2__.getCard)('http://localhost:3000/menu').then(function (data) {
...
function forms(modalSelector) {
  var forms = document.querySelectorAll('form'); // const postData = async (url, data) => {
  //     let res = await fetch(url, {
  //         method: 'POST',
  //         headers: {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_8__.postData)('http://localhost:3000/requests', json).then(function (desc) {
        console.log('Все збс');
        console.log(desc);
      }).catch(function () {
        ...
        form.reset();
        (0,_modal__WEBPACK_IMPORTED_MODULE_7__.modalClose)(modalSelector);
      });
    });
  });
}
...
function modal(dataModalSelector, modalSelector, modalCloseSelector) {
  var btn = document.querySelectorAll(dataModalSelector);
  var modal = document.querySelector(modalSelector);
  var modalCloseBtn = document.querySelector(modalCloseSelector);
...
function slider() {
  ...
  function showSlide(n) {
    ...
    if (slides.length < 10) {
      current.textContent = "0".concat(count);
    } else {
...
function getCard(_x3) {
  return _getCard.apply(this, arguments);
}

function _getCard() {
  _getCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
    var res;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.default)('[data-modal]', '.modal', '.modal__close');
